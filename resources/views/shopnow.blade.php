  ...
  <section class="section product">
    <div class="container">
      ...
      <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
          <button class="filter-btn" style="width: 3rem; height: 3rem;" id="Trendy-products-tab" type="button" role="tab" aria-controls="Trendy-products" aria-selected="false">
          <img src="{{ asset('public/assets/images/6145971.png') }}" width="20" alt="" class="default" style="width:3rem">
            <img src="{{ asset('public/assets/images/6145971.png') }}" width="20" alt="" class="color" style="width:3rem">
          Trendy products
          </button>
        </li>
              ...
              <li class="grid-item">
                <div class="product-card newclass">
                  <figure class="card-banner">
                    <img src="{{ asset($product->image) }}" loading="lazy" alt="Product Image" >
...
<input type="hidden" name="quantity" value="1">
  ...
  <div class="tooltip">Add to Wishlist</div>
        ...
        <div class="tab-pane" id="Trendy-products" role="tabpanel" aria-labelledby="Trendy-products-tab">
          <!-- Content for the Dairy Products tab -->
